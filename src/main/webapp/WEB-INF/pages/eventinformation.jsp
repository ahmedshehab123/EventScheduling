						...
						<center>
							...
							<c:if test="${sessionScope.userlogin.email!=null }">
								...
								you is the owner of this event
									...
									<a href="displaysponsornotify?eventID=${event.eventID }">you choose this event before to be asponor of it click to see it</a>
										</c:if>
								</c:if>
								<c:if test="${event.status==true }"><h4>this event is private only people have invitation can access it</h4></c:if>
							</c:if>
						</center>
					</td>
				</tr>
